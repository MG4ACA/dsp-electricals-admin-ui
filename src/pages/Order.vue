          ...
          <div class="inventory-content-manage-div">
            <div class="formgrid">
                    ...
                    <div class="formgrid grid">
                      <div class="field col-12 md:col-5">
                        ...
                        <InputNumber
                          ...
                          :maxFractionDigits="5"
                          class="input-fields"
                          @update:modelValue="calculateTotalValue"
                        />
                      </div>
                      <div class="field col-12 md:col-5">
                      ...
                      <div class="field col-12 md:col-4">
                        ...
                        <div class="p-chip">Rs: &nbsp; {{ totalPrice }}.00</div>
                      </div>
                    </div>
                  </Fieldset>
                </div>
              ...
              <div class="form-button-set">
                <Button class="btn-success" label="ADD TO TABLE" @click="saveProductDetails" />
            ...
            <div class="formgrid order-table-container">
              ...
              <div class="submit-order-button-class mt-3">
                <Button
                  class="btn-success"
                  :label="isUpdateProduct ? 'Update' : 'PLACE ORDER'"
...
const onSearch = (event) => {
  console.log('product___________', products.value)
  setTimeout(() => {
...
const filterSelectedProduct = () => {
  console.log('slected product', selectedProduct.value._id)
  filteredProduct.value = products.value.filter((product) => {
    return product.name?.toLowerCase().includes(event.query.toLowerCase())
  })
}
...
const calculateTotalValue = () => {
  if (sellingPrice.value && productQuantity.value) {
    totalPrice.value = sellingPrice.value * productQuantity.value
  }
}
</script>
