                    ...
                    <div class="stock-content-manage-div">
                        <div class="formgrid grid">
                            <div class="field col-12 md:col-12 mb-6">
                                ...
                                <div class="card flex">
                                    <AutoComplete v-model="selectedStock" optionLabel="name" :suggestions="filteredStock"
                                        @complete="onSearch" @item-select="onSelectedStock" style="width: 50%" />
                                </div>
                            </div>
                            <div class="field col-12 md:col-6">
                                <label for="stockCode">Company Name</label>
                                <AutoComplete v-model="selectedCompany" optionLabel="company"
                                    class="text-base text-color w-full" :suggestions="filteredSellers" @complete="onSearchSellers" @item-select="onSelectedCompany">
                            ...
                            <div class="field col-12 md:col-6">
                                ...
                                <AutoComplete v-model="selectedProduct" optionLabel="name"
                                    class="text-base text-color w-full" :suggestions="filteredProducts" @complete="onSearchProducts" @item-select="onSelectedProduct">
                                    <template #option="slotProps">
                                        <div class="flex align-options-center">
                            ...
                            <div class="formgrid grid col-12">
                                <div class="field col-12 md:col-4">
                                    <div class="field">
                                        ...
                                        <input id="companyName" type="text" v-model="buyingPrice"
                                            class="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full">
                                    </div>
                                    <div class="field ">
                                        <label for="companyName">Quantity</label>
                                        <input id="companyName" type="text" v-model="quantity"
                                            class="text-base text-color surface-overlay p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full">
                                    </div>
                                </div>
                                <div class="field col-12 md:col-8">
                                    <label for="description">Description</label>
                                    <textarea id="description" type="text" rows="5" v-model="description"
...
const saveStockDetails=() => {
    ...
    if(res) {
        toast.add({ severity: 'success', summary: TOAST_MESSAGES.SUCCESS.TITLE, detail: 'Stock saved successfully', life: 3000 });
    } else {
